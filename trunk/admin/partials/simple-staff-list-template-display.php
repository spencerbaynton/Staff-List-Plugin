...
// Get options for default HTML CSS
	...
	$output  = '<div class="wrap sslp-template">';
		...
		$output .= '<div class="sslp-content sslp-column">';
		    ...
		    $output .= '<p>' . __( 'These <strong>MUST</strong> be used inside the <code>[staff_loop]</code> wrapper. The unformatted tags will return plain strings so you will want to wrap them in your own HTML. The <code>[staff_loop]</code> can accept any HTML so be careful when adding your own HTML code. The formatted tags will return data wrapped in HTML elements. For example, <code>[staff-name-formatted]</code> returns <code>&lt;h3&gt;STAFF-NAME&lt;/h3&gt;</code>.', 'simple-staff-list' ) . '</p>';
		    $output .= '<br />';
